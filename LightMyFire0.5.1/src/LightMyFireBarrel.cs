...
namespace LightMyFire
{
    ...
    public sealed class LightMyFireBarrel : MonoBehaviour
    {
        ...
        private void RefundLocally(int amount)
        {
            ...
            EnsureConfiguration();
            // AddItem(name, amount, quality, variant, crafterID, crafterName) is the vanilla helper
            // that resolves the ItemDrop prefab by shared name and stacks it into the inventory.
            _inventory.AddItem(_fuelItemName, amount, 1, 0, 0L, string.Empty);
        }
