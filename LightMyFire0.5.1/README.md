...
**Version 0.5.3 is a publishing metadata update.**
> **0.5.3 note:** moves the human/AI development disclosure to the top of the Thunderstore details and adds a concise disclosure to the package manifest description. No gameplay changes are intended relative to 0.5.2.
