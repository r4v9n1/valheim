...
Write-Host "Installed LightMyFire 0.5.3: $Target" -ForegroundColor Green
Write-Host "DLL SHA256: $installedHash"
Write-Host "Install the SAME 0.5.3 build on the dedicated server before connecting." -ForegroundColor Cyan
