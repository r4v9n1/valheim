...
- Preserves the existing barrel, fuel filtering, refill, multiplayer transaction, and asset-bundle behavior.
- Replaced the package icon with a custom-made, non-AI-generated icon.

## 0.5.4

- Automatic barrel refills now update light fuel silently without the source's fuel-added sound or visual effect.
