...
namespace LightMyFire
{
    ...
    public sealed class LightMyFirePlugin : BaseUnityPlugin
    {
        ...
        // ValheimModding-Jotunn-2.30.0 dependency in thunderstore/manifest.json) before shipping, and
        ...
        private void Awake()
        {
            ...
            // Public 0.5.4 release keeps the 5-minute refill default introduced during development.
