...
$FixedBundleBuilderPath = Join-Path $ProjectRoot "BuildPhysicalWaterBundle-0.3.12.cs.fixed"
...
& (Join-Path $ProjectRoot "build-0.3.12.ps1") -ValheimDir $ValheimDir -Configuration $Configuration
...
Write-Host ""
Write-Host "PhysicalWater 0.3.12 milestone: no-jelly stable mesh guardrail plus dedicated shoreline foam overlay mesh."
