...
title PhysicalWater E3 Geometry Handshake Repair

echo.
echo ============================================================
echo   PhysicalWater E3 Geometry Handshake Repair
echo ============================================================
echo.
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0FIX-E3-GEOMETRY-HANDSHAKE.ps1"
set ERR=%ERRORLEVEL%
