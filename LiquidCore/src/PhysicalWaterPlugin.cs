...
namespace PhysicalWater
{
    ...
    public sealed class PhysicalWaterPlugin : BaseUnityPlugin
    {
        ...
        public const string PluginVersion = "0.6.0-devE3.2-probe4";
        public const string PluginBepInExVersion = "0.6.0.20";
        public const string PluginAssemblyVersion = "0.6.0.20";
