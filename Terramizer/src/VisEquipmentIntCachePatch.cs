...
namespace Terramizer
{
    ...
    internal static class VisEquipmentIntCachePatch
    {
        ...
        {
            // A missing table is equivalent to vanilla ZDO.GetInt's default.
            // The dictionary itself is read-only here; updates still go through
            // Valheim's normal ZDO path and retain its network behavior.
